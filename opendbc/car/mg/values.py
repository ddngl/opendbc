...
class CAR(Platforms):
  ...
  MG_MARVEL_R = MgPlatformConfig(
    [
      MgCarDocs("MG Marvel R 2022"),
    ],
    CarSpecs(mass=1930., wheelbase=2.80, steerRatio=15.8),  # TODO(drive): verify mass/steerRatio
  )
...
class CarControllerParams:
  ...
  STEER_MAX = 300
  STEER_DELTA_UP = 7       # torque increase per refresh (ISO jerk limit: up_jerk 2.92<=3.0)
  STEER_DELTA_DOWN = 11    # torque decrease per refresh (ISO jerk limit: down_jerk 4.58<=5.0)
